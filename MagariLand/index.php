      ...
      <div class="owl-banner owl-carousel">
        <div class="banner-item-01">
          <div class="text-content">
            ...
            <h2>Welcome to Magariland</h2>
          </div>
        </div>
        <div class="banner-item-02">
          <div class="text-content">
            <h4>Find the Right car in your budget</h4>
            <h2>Explore quality within reach</h2>
          </div>
        </div>
        <div class="banner-item-03">
          <div class="text-content">
            <h4>Unlock an exceptional driving experience</h4>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php $query=mysqli_query($con,"select * from tblcars limit 6");
