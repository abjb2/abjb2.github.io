...
<head>
    ...
    <link href="https://fonts.cdnfonts.com/css/recharge" rel="stylesheet">
    <style>
        ul#cardetails li
        {
            display:inline;
    ...
    <title>Magariland LTD | Drive in Africa</title>
    ...
    <style>
        @import url('https://fonts.cdnfonts.com/css/recharge');
    </style>
...
<div class="about-heading header-text" >
    <div class="container">
        <div class="row">
            ...
            <!--              <h4> <strong class="text-primary">Ksh --><?php //echo $row['CarPrice'];?><!--</strong></h4>-->
...
<div class="products container ">
    <div class="container">
        <div class="slides">
            <img src="admin/images/<?php echo $row['CarImage'];?>"  style="width: 100%">
        </div>
        <div class="slides">
            <img src="admin/images/<?php echo $row['CarImage1'];?>"  style="width: 100%">
        </div>
        <div class="slides">
            <img src="admin/images/<?php echo $row['CarImage2'];?>"  style="width: 100%">
        </div>
        <div class="slides">
            <img src="admin/images/<?php echo $row['CarImage3'];?>"  style="width: 100%">
        </div>
        <div class="slides">
            <img src="admin/images/<?php echo $row['CarImage4'];?>"  style="width: 100%">
        </div>
        ...
        <div class="container row mt-3">
            <div class="column">
                <img class="demo cursor" src="admin/images/<?php echo $row['CarImage'];?>" style="width:100%" onclick="currentSlide(1)" alt="">
            </div>
            <div class="column">
                <img class="demo cursor" src="admin/images/<?php echo $row['CarImage1'];?>" style="width:100%" onclick="currentSlide(2)" alt="">
            </div>
            <div class="column">
                <img class="demo cursor" src="admin/images/<?php echo $row['CarImage2'];?>" style="width:100%" onclick="currentSlide(3)" alt="">
            </div>
            <div class="column">
                <img class="demo cursor" src="admin/images/<?php echo $row['CarImage3'];?>" style="width:100%" onclick="currentSlide(4)" alt="">
            </div>
            <div class="column">
                <img class="demo cursor" src="admin/images/<?php echo $row['CarImage4'];?>" style="width:100%" onclick="currentSlide(5)" alt="">
            </div>
            <!--                    <div class="column">-->
            <!--                        <img class="demo cursor" src="admin/images/--><?php //echo $row['CarImage3'];?><!--" style="width:100%" onclick="currentSlide(6)" alt="Snowy Mountains">-->
            <!--                    </div>-->
        </div>
    </div>
    <!--            <div class="row">-->
    ...
    <div class="section mt-4">
        <div class="container">
            <div class="section-heading">
                <h3 class="text-uppercase text-center">Vehicle Description</h3>
            </div>
            <div class="left-content">
            ...
            <div class="clearfix">
                <ul id="cardetails" >
                    <li style="padding-right: 50px">
                        <img src="assets/icons/year.png" height= "25px">
                        <span><?php echo $row['RegYear'];?></span>
                        </img>
                    </li>
                    <li style="padding-right: 50px">
                        <img src="assets/icons/engine.png" height= "25px">
                        <span><?php echo $row['EngineCapacity'];?></span>
                        </img>
                    </li>
                    <li style="padding-right: 50px">
                        <img src="assets/icons/gear.png" height= "25px">
                        <span><?php echo $row['TransmissionType'];?></span>
                        </img>
                    </li>
                    <li style="padding-right: 50px">
                        <img src="assets/icons/fuel.png" height= "25px">
                        <span><?php echo $row['FuelType'];?></span>
                        </img>
                    </li>
                    <li style="padding-right: 50px">
                        <img src="assets/icons/mileage.png" height= "25px">
                        <span><?php echo $row['KmDriven'];?></span>
                        </img>
                    </li>
                    <li style="padding-right: 50px">
                        <img src="assets/icons/price.png" height= "25px">
    ...
    while($result=mysqli_fetch_array($ret)){
        ...
        <div class="section mt-1">
            <div class="container">
                <div class="section-heading">
                    <h3 class="text-uppercase text-center">Contact Details</h3>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="left-content">
                    ...
                    <div class="col-md-6">
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Make a Enquiry</button>
                    </div>
                </div>
            </div>
        </div>
